import Work1 from "../../../assets/img/Frontend/work1.png";
import Work2 from "../../../assets/img/Frontend/work2.png";
import Work3 from "../../../assets/img/Frontend/work3.png";
import Work4 from "../../../assets/img/Frontend/work4.png";
import Work5 from "../../../assets/img/Frontend/work5.png";
import Work6 from "../../../assets/img/Frontend/work6.png";
import Work7 from "../../../assets/img/Frontend/work7.png";
import Work8 from "../../../assets/img/Frontend/work8.png";
import Work9 from "../../../assets/img/Designs/work1.png";
import Work10 from "../../../assets/img/Designs/work2.png";
import Work11 from "../../../assets/img/Backend/work1.png";
...
export const projectsData = [
  {
    ...
    description:
      "Web platform that allows you to search for series and movies through integration with the OMDBAPI API. It provides detailed information on titles, synopsis and relevant data to facilitate content selection.",
    category: "web",
    techs: [
      {
        id: 1,
  ...
  },
  {
    ...
    description:
      "Web application designed to visualize the state of the weather in real time, using the OpenWeatherAPI API. It provides detailed weather information such as temperature, humidity and current weather conditions.",
    category: "web",
    techs: [
      {
        id: 1,
  ...
  },
  {
    ...
    description:
      "Web tool that allows you to generate custom color scales, ideal for designers and developers looking to optimize the creation of harmonious and effective color palettes.",
    category: "web",
    techs: [
      {
        id: 1,
  ...
  },
  {
    ...
    title: "Translator",
    description:
      "Real-time language translator developed using the MyMemory API to offer a simple and efficient experience in the instant translation of texts between different languages.",
    category: "web",
    techs: [
      {
        id: 1,
  ...
  },
  {
    ...
    description:
      "Messaging application designed to facilitate real-time communication. Built with modern technologies, it includes features for sending and receiving messages in a seamless manner.",
    category: "app",
    techs: [
      {
        id: 1,
  ...
  },
  {
    ...
    description:
      "Web invoicing system oriented to sales management in bookstores. It works as a CRM, allowing the visualization of quantifiable data, sales analysis and efficient inventory management.",
    category: "web",
    techs: [
      {
        id: 1,
  ...
  },
  {
    ...
    description:
      "E-commerce application developed for a technology products store. It includes catalog, shopping cart and order processing functionalities, ensuring an optimized user experience.",
    category: "app",
    techs: [
      {
        id: 1,
  ...
  },
  {
    ...
    description:
      "The banking collection system based on role-based authentication, offers several options for service payments, transactions and reporting along with a highly intuitive data dashboard.",
    category: "frontend",
    techs: [
      {
        id: 1,
  ...
  },
  {
    ...
    description:
      "The bank collection system API offers secure endpoints for payment processing, transaction validation and reporting, facilitating automated collection management in applications.",
    category: "backend",
    techs: [
      {
        id: 1,
  ...
  },
  {
    ...
    description:
      "Professional design of a dashboard focused on vulnerability management and visualization. This design prioritizes clarity, usability and organization of critical information.",
    category: "design",
    techs: [
      {
        id: 1,
  ...
  },
  {
    ...
    description:
      "Conceptual design of a mobile application for neurodivergent people. The proposal focuses on accessibility, usability and an inclusive experience for diverse users.",
    category: "design",
    techs: [
      {
        id: 1,
