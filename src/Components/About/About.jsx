        ...
        <div className="row">
          ...
          <div className="col-md-6 col-sm-12 d-flex align-items-center">
            <p>
              ...
              using various design tools such as Figma. As for development, I
              have experience in web application development using technologies
              such as JavaScript using React.js, Node.js and Express.js, Php
              using Laravel and MySQL, SQL Server and PostgreSQL to <span className="subtitle font-weight-bold">relational database development</span> or MongoDB to <span className="subtitle font-weight-bold">no relational
              database development</span>.
              <br /> <br />I'm currently pursuing a pre-specialty in <span className="subtitle font-weight-bold">[name of
              pre-specialty]</span> at the{" "}
              <span className="subtitle font-weight-bold">
